...
?>
      ...
      <!--    <h1>Boutique en ligne simplifiée</h1> -->
          ...
          <hr>
            ...
            <h1>Modification de la nourriture "<?php echo $donnees['description']; ?>"</h1>
            <div class="row">
              <div class="col-sm-4">
                <form id="modifierNourriture" name="modifierNourriture" method="post" action="modifierNourriture.php?id=<?php echo $_GET['id']; ?>">
                  ...
                  <button type="submit" class="submitenabled btn btn-primary" name="submitNourriture" id="submitNourriture" disabled>Modifier la nourriture</button>
      <?php
