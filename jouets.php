          ...
          <div >
            <table class="table table-bordered table-hover table-striped">
              <thead class="thead-dark">
                <tr>
                  <th>Nom <a href="jouets.php?tri=nom&order=asc#tablo" title="Tri croissant"><i class="triascnom fas fa-arrow-alt-circle-down"></i></a><a href="jouets.php?tri=nom&order=desc#tablo" title="Tri décroissant"><i class="tridescnom disphid fas fa-arrow-alt-circle-up"></i></a></th>
                  <th>Description <a href="jouets.php?tri=description&order=asc#tablo" title="Tri croissant"><i class="triascdesc fas fa-arrow-alt-circle-down"></i></a><a href="jouets.php?tri=description&order=desc#tablo" title="Tri décroissant"><i class="tridescdesc disphid fas fa-arrow-alt-circle-up"></i></a></th>
                  <th>Prix <a href="jouets.php?tri=prix&order=asc#tablo" title="Tri croissant"><i class="triascprix fas fa-arrow-alt-circle-down"></i></a><a href="jouets.php?tri=prix&order=desc#tablo" title="Tri décroissant"><i class="tridescprix disphid fas fa-arrow-alt-circle-up"></i></a></th>
                  <th>Quantité stock <a href="jouets.php?tri=quantiteStock&order=asc#tablo" title="Tri croissant"><i class="triascqte fas fa-arrow-alt-circle-down"></i></a><a href="jouets.php?tri=quantiteStock&order=desc#tablo" title="Tri décroissant"><i class="tridescqte disphid fas fa-arrow-alt-circle-up"></i></a></th>
                  <th>Image</th>
