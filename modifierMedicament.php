...
?>
      ...
      <!--    <h1>Boutique en ligne simplifiée</h1> -->
          ...
          <hr>
            ...
            <h1>Modification du médicament "<?php echo $donnees['description']; ?>"</h1>
            <div class="row">
              <div class="col-sm-4">
                <form id="modifierMedicament" name="modifierMedicament" method="post" action="modifierMedicament.php?id=<?php echo $_GET['id']; ?>">
      ...
      ?>
      <br><br>
      <a href="medicaments.php#tablo"><i class="far fa-arrow-alt-circle-left">&nbsp;</i>Revenir à la liste des médicaments</a><br>
